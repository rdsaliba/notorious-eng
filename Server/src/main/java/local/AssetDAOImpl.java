...
public class AssetDAOImpl extends DAO implements AssetDAO {
    ...
    //private static final String GET_ALL_LIVE_ASSETS_DESCENDING="SELECT DISTINCT asset.*,asset_type.* FROM asset, asset_type, asset_model_calculation WHERE asset.asset_type_id=asset_type.asset_type_id AND asset.asset_id=asset_model_calculation.asset_id AND archived = false ORDER BY asset_model_calculation.value DESC";
...
//    /**
//     * This will return a sorted arraylist of all assets that are not archived
//     *
//     * @author Najim
//     */
//    @Override
//    public ArrayList<Asset> getAllLiveAssetsSorted() {
//        ArrayList<Asset> assets = new ArrayList<>();
